  ...
  <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-warning py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
      <a href="index.php" class="navbar-brand ms-4 ms-lg-0">
        <h1 class="fw-bold text-primary m-0"><img src="foto/logo.png" style="border-radius:10px;width:100px"><span class="text-white" style="padding-left:25px;">E - Absensi</span></h1>
      </a>
